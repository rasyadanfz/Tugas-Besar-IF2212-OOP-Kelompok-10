...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "\033[1;92m _______  ___   __   __             _______  ___      ___   _______  ___   _______  __   __ ");
        System.out.println(
                "\033[1;92m|       ||   | |  |_|  |           |       ||   |    |   | |       ||   | |       ||  | |  |");
        System.out.println(
                "\033[1;92m|  _____||   | |       |   ____    |    _  ||   |    |   | |       ||   | |_     _||  |_|  |");
        System.out.println(
                "\033[1;92m| |_____ |   | |       |  |____|   |   |_| ||   |    |   | |       ||   |   |   |  |       |");
        System.out.println(
                "\033[1;92m|_____  ||   | |       |           |    ___||   |___ |   | |      _||   |   |   |  |_     _|");
        System.out.println(
                "\033[1;92m _____| ||   | | ||_|| |           |   |    |       ||   | |     |_ |   |   |   |    |   |  ");
        System.out.println(
                "\033[1;92m|_______||___| |_|   |_|           |___|    |_______||___| |_______||___|   |___|    |___|  ");
        System.out.println(
                "\033[1;92m================================================================================================\n\n");
